...
defined('ROKET_CS_AI_AGENT_SURCHARGE_COVERAGE_URL')	OR define('ROKET_CS_AI_AGENT_SURCHARGE_COVERAGE_URL', $_ENV['ROKET_CS_AI_AGENT_SURCHARGE_COVERAGE_URL'] ?: 'https://example.com/api/get-coverage-surcharge');
