  ...
  <head>
	...
	<style>
		...
		*:focus{outline:none!important;}
		...
		table tr td,table tr th{padding-top:4px;padding-bottom:8px;}
	...
	<div class="main-wrapper mt-15">
		<div class="main-wrapper">
			<div class="content-body m-0 p-0" style="background-color: #f6f6f6;padding: 4px;">
				<div id="mainContainer" class="row" style="background-color: #fff; width:75%; margin:40px auto; margin-bottom:10px; border-radius:6px; padding: 20px;">
					<table border="0" width="100%" cellspacing="0">
						<tr>
							<td width="18%" align="center" valign="top" style="padding-top:16px; padding-bottom:16px">
								<img src="<?=DOMAIN_HTTP_TYPE?>:<?=BASE_URL_ASSETS?>img/logo-color.png" alt="" height="80px">
							</td>
							<td width="32%" valign="top">
								<h3><?=COMPANY_NAME?></h3>
								<small><?=COMPANY_ADDRESS?><br/><?=COMPANY_PHONE?><br/><?=COMPANY_EMAIL?></small>
							</td>
							<td width="50%" align="right" style="padding-top:16px; padding-bottom:16px">
								<img src="<?=DOMAIN_HTTP_TYPE?>://<?=DOMAIN_MAIN?>/foto/sourceLogo/LogoSource_20220424064725.jpg" alt="" height="25px">
								<b class="previewFont">Booking No.</b><br/>
								<span class="previewFont previewValue text-right" id="invoiceNumberComposerContainer">ABC2319861</span><br/><br/>
								<b class="previewFont">Activity/Tour Date</b><br/>
								<span class="previewFont previewValue text-right" id="invoiceDateComposerContainer">Sep 4 2023</span><br/><br/>
							</td>
						</tr>
					</table>
					<div class="col-12 mt-15 mx-1" style="border-top: 2px solid #e0e0e0;"></div>
					<div class="col-3 mt-15" style="margin-top: 15px">
						<b>Dear MRS Jii Hooo,</b>
						<p>Thank you for choosing Bali SUN Tours as your travel companion. We would like to confirm your booking with details as below</p>
					</div>
						...
						<table border="0" width="100%" cellspacing="0">
							<thead>
								<tr>
									...
									<th style="border-bottom: 2px solid #e0e0e0;" class="previewFont text-right" align="right" width="160">RATE</th>
									<th style="border-bottom: 2px solid #e0e0e0;" class="previewFont text-right" align="right" width="80">QTY</th>
									<th style="border-bottom: 2px solid #e0e0e0;" class="previewFont text-right" align="right" width="160">AMOUNT</th>
								</tr>
							</thead>
							<tbody id="invoiceItemBody">
								...
								<tr class="previewFont">
									...
									<td style="border-bottom: 1px solid #e0e0e0;" align="right"><b>Rp. <span id="totalInvoiceItem"><?=$totalItemAmount?></span>,-</b></td>
								</tr>
								<tr class="previewFont">
									<td></td>
									<td style="border-bottom: 2px solid #e0e0e0;"><b>BALANCE</b></td>
									<td style="border-bottom: 2px solid #e0e0e0;" colspan="2" align="right"><b>Rp. <span id="totalBalanceInvoice"><?=$totalBalance?></span>,-</h6></td>
								</tr>
								<tr class="previewFont">
									<td></td>
									<td style="border-bottom: 2px solid #e0e0e0;"><b>DUE</b></td>
									<td style="border-bottom: 2px solid #e0e0e0;" colspan="2" align="right"><b>Rp. <span id="totalBalanceDueInvoice"><?=$totalInvoiceAmount?></span>,-</b></td>
								</tr>
							</tbody>
						</table>
					</div>
