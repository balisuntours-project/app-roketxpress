<div class="row justify-content-between align-items-center">
	<div class="col-12 col-lg-auto mb-20">
		<div class="page-heading">
			<h3 class="title">Collect Payment <span> / List of payment collect by vendor</span></h3>
		</div>
	</div>
</div>
<div class="box mb-10">
					...
					<div class="col-lg-5 col-sm-12">
						...
						<div class="order-details-customer-info">
							<ul class="ml-5">
								...
								<li> <span>Vendor</span> <span id="vendorNameTypeStr">-</span> </li>
							</ul>
						</div>
					</div>
...
<script>
	var url 	=	"<?=BASE_URL_ASSETS?>js/page-module/FinanceVendor/collectPayment.js?<?=date('YmdHis')?>";
	$.getScript(url);
</script>