<div class="row justify-content-between align-items-center mb-10">
	<div class="col-12 col-lg-auto mb-20">
		<div class="page-heading">
			<h3 class="title">User Partner Level Menu <span> / List menu by user partner level</span></h3>
		</div>
	</div>
</div>
<div class="row">
			...
			<div class="box-body" id="formLevelMenu">
				<div class="row">
					<div class="col-sm-8 mb-10">
						...
						<select class="form-control" name="userPartnerLevel" id="optionUserPartnerLevel" onchange="generateTableLevelUserPartnerMenu(this.value)"></select>
					</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
			...
			<div class="modal-body">
				Save menu changes on level <b id="textUserPartnerLevel"></b>?
			</div>
...
<script>
	var url = "<?=BASE_URL_ASSETS?>js/page-module/SettingPartner/userPartnerLevelMenu.js";
	$.getScript(url);
</script>